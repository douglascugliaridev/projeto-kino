...
export default function Elenco({ elenco }: ElencoProps) {
    ...
    return (
        <Container className="pb-0 pt-10">
            <Titulo texto="Elenco" alinhar="center" className="mb-4" />

            <Flex className="flex-wrap mt-14 mb-8">
                {elenco.map((ator, i) => (
                            ...
                            <AnimatePresence>
                                {indiceSelecionado === i && (
                                    ...
                                    >
                                        ...
                                        <div className="text-xs text-white">{ator.nome}</div>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                            <div className={`h-24 w-24 rounded-full
                            border-2 border-white relative transition duration-500 group-hover:scale-105 group-hover:z-30
                            `}>
